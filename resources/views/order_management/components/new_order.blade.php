                    ...
                    <form action="#" class="form-vertical orderConfirm" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="d-flex">
                                    <select class="form-control select2" id="customerLists" name="customer_id">
                                    </select>
                        ...
                        <div class="productlist">
                            <div class="slimScrollDiv"
                                ...
                                <div class="product-list pdlist" style="overflow: hidden; width: auto; height: 500px;">
                        ...
                        <div class="fixedclasspos">
                            <div class="row d-flex flex-wrap align-items-center">
                                ...
                                <div class="col-sm-6 text-right">
                                    ...
                                    <input type="button" class="btn btn-primary btn-large cusbtn" value="0"
                                        id="totalAmountShow">
